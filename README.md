...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/lsst-versions-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/lsst-versions-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add lsst-versions
# for installing globally
pixi global install lsst-versions
```
...
It is possible to list all of the versions of `lsst-versions` available on your platform:
...
```
pixi search lsst-versions --channel conda-forge
```
